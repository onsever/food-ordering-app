        ...
        <div className="flex gap-x-4 items-center">
          ...
          <Link href="/cart">
            <span className="relative">
              ...
              <span className="w-4 h-4 text-xs grid place-items-center rounded-full bg-primary absolute -top-2 -right-3 text-black font-semibold">{cart.products.length === 0 ? "0" : cart.products.length}</span>
            </span>
          </Link>
          ...
          <Link href="#" className="md:inline-block hidden cursor-pointer">
            <button className="btn-primary md:inline-block hidden cursor-pointer">
              Order Online
            </button>
          </Link>
          <button
